...
import { cartCount, cartItemCount, cartItemTemplate, cartTotal } from "../core/selector";
...
export const calculateCartCostTotal = () => {
    const total = [...document.querySelectorAll(".cart-item-price")].reduce((pv,cv) => pv + parseFloat(cv.innerText),0);
    return total;
}
